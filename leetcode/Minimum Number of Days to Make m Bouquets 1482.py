...
'''
My solution failed on exceeding time

better solution, rather than going through each date in list,
use a binary search to check is that day works, very cool
